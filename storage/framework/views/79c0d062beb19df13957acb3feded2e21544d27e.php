    ...
    <div class="modal-content">
      <form name="viewPhoto" ng-submit="submitModal('viewPhoto')" files="true" novalidate>
        ...
        <div class="modal-body">
          ...
          <button ng-disabled="comment.length == 0" type="button" id="postCommentButton" ng-click="postComment(<?php echo e($user->user_profile); ?>)" ng-disabled="viewPhoto.$invalid" class="post-comment-btn form-btn main-btn stroke-btn"><i class="fa fa-check"></i></input></button>
              </form>
