...
<?php $__env->startSection('content'); ?>
  <div data-ng-controller="ProfileController" class="profile-container"> 
    <?php echo $__env->make('modals.addSelfiePhoto', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
          ...
          <div id="userPhotoProfile" ng-init="[[initLightGallery()]]" ng-if="user.verify_check !== 'PENDING'"> 
			  ...
			  <h4>
				...
				<div class="add-gallery-photo" style="background:transparent;" ng-if="user.verify_check != 'VERIFIED'">
					<button type="button" data-ng-click="openModal('addSelfiePhoto')"><i class="fa fa-camera"></i> <?php echo e(Lang::get('messages.addSelfiePhoto')); ?></button>
				</div>		  
			</div>
		</div>
