              ...
              <?php endif; ?> 
                <div class="offer_left">
                  <a href="<?php echo e(url('users/'.$offers->username)); ?>">
                    ...
                    <?php else: ?>
                    <img src="img/users/<?php echo e($offers->username); ?>/previews/<?php echo e($offers->img); ?>" class="offer_pro_pic" />
                    <?php endif; ?>
                  </a>
                  <h3>
                ...
                <!-- pop call close -->  
                  <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.countdown/2.2.0/jquery.countdown.js"></script>
                    ...
                    <br/><br/>
                    <span class="offer_id">
                      Id: #<?php echo e($offers->post_id); ?>

                    </span>
                    <?php if($offers->user_id == Auth::user()->id OR Auth::user()->username == 'Admin'): ?>
                      <a onclick = "delete_confirmation(<?php echo e($offers->post_id); ?>)">
                       <span class="fa fa-trash offer_delete"></span>
                      </a>
                    <?php endif; ?> 
                  </div> 
                </div>
        ...
        <div class="col-md-12">
          ...
          <div class="col-md-6 offer_container_grid">
            <div class="offer_cont_shadow">
              ...
              <div class="offer_right">
                <h3>
                  <span><?php echo e($interested->currency); ?><?php echo e($interested->offer_rate); ?></span>
                </h3>
              </div> 
              <div class="offer_detailes_box">
                <p>
              ...
              <span class="post_remaining" id="clock_loged_interest<?php echo e($interested->id); ?>">
              </span>
              <span class="post_remaining">
                <?php 
                  $date_a = new DateTime(date("F j, Y, H:i:s"));
        ...
        <div class="modal fade" id="logged_interested" role="dialog">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body" id="my_logged_interested"></div>
              <div class="modal-footer">
                <button type="button" id="refreshdata" class="btn btn-default" data-dismiss="modal">Close</button>
              </div>
            </div>
