            ...
            <div id="userPhotoProfile">
                <div class="image" lightgallery data-src="[[getUserPhotoUrl(user.img)]]">
                    <a href="[[getUserPhotoUrl(user.img)]]" class="lightGallery" title="[[user.username]]">
                        <img ng-if="[[getPhotoPreviewUrl(user.img == '')]]" src="<?php echo e(url('/')); ?>/img/female.jpg" alt="profile pic" />
                    </a>
                    <a href="[[getUserPhotoUrl(user.img)]]" class="lightGallery" title="[[user.username]]">
                        <img ng-if="[[getPhotoPreviewUrl(user.img != '')]]" src="<?php echo e(url('/')); ?>/img/male.jpg" alt="profile pic" />
                    </a>
