...
<?php $__env->startSection('content'); ?>  
  <?php if(Auth::user()->gender == 'male' && true == false): ?>
        ...
        <div class="description block-flex wrap-flex">
          <div class="sub-column">
            ...
            <div class="sub-column hidden">
              <p><span>Account type:</span> <?php if($subscribed == 1): ?> Premium <?php else: ?> Standard <?php endif; ?></p>
              <?php if($subscribed == 1): ?>
                <p><span>Order</span> #<?php echo e($orders[0]->id); ?></p>
                <p><span>Plan:</span> <?php echo e($orders[0]->plan->name); ?></p>
                <p><span>Payment method:</span> <?php echo e($orders[0]->payment_method); ?></p>
                <p><span>Start date:</span> <?php echo e(date("d/m/Y", strtotime($orders[0]->created_at))); ?></p>
                <p><span>End date:</span> <?php echo e(date("d/m/Y", strtotime($orders[0]->created_at->addMonth($orders[0]->plan->period)))); ?></p>
              <?php else: ?>
