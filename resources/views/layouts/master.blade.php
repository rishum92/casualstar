...
<script>
  ...
  @if(Auth::check())
    ...
    <link href="{{ URL::asset('components/angular-bootstrap-calendar/dist/css/angular-bootstrap-calendar.min.css') }}" rel="stylesheet">
  ...
  <link href="{{ URL::asset('components/slick-carousel/slick/slick-theme.css') }}" rel="stylesheet">
  ...
  <link href="{{ URL::asset('css/competitions/competitions.css') }}" rel="stylesheet">
  <link href="{{ URL::asset('css/competitions/simple-line-icons.css') }}" rel="stylesheet">
          ...
          <div class="block-flex wrap-flex vertical-center-flex">
            ...
            <ul class="block-flex wrap-flex vertical-center-flex"> 
              ...
              <!-- <li><a class="@if(Route::is('offers') || Route::is('offers')) active @endif" href="{{ URL::route('offers') }}"><i class="ion-star"></i>Offer</a>
                  @if($offercount > 0)
                    @if($offercount < 100)
                    <span class="small-notif">{{$offercount}}</span>
                   @else
                    <span class="small-notif larger">99+</span>
                  @endif
                 @endif 
           ...
           <!--Start of div--> <div class="{{(Auth::user()->gender == 'male') ? 'image' : 'image image_ver_twit'}}">
            <!--<div class="image">-->
              ...
              <div class="logout">
                ...
                <hr>
                <a href="{{ URL::route('settings') }}"><i class="ion-wrench"></i>Settings</a>
                <hr>
				<!--@if(Auth::user()->id != 1)
    ...
    <footer>
      <ul class="footer-menu">
        ...
        @if(Auth::user() && Auth::user()->title == 'ADMIN')
          ...
          <li>
&nbsp;
            <a href="{{ URL::route('admin.banner.ads') }}">
              @if($bannerAdRequestCount > 0)
                @if($bannerAdRequestCount > 99)
                    <?php $bannerAdRequestCount = "99+" ?>
                    <?php $over99 = 'true'; ?>
                @else
                    <?php $over99 = 'false'; ?>
                @endif
                <span class="banner-ad-notification" data-count="<?=$bannerAdRequestCount ?>" data-over99="<?=$over99?>">{{$bannerAdRequestCount}}</span>
              @endif
    ...
    @if(Auth::check())
      ...
      <script src="{{ URL::asset('components/angular-slick-carousel/dist/angular-slick.min.js') }}" type="text/javascript"></script>
      ...
      <script src="{{ URL::asset('components/angular-bootstrap-calendar/dist/js/angular-bootstrap-calendar-tpls.min.js') }}" type="text/javascript"></script>
    ...
    @if(Auth::check())
      ...
      <script src="{{ URL::asset('js/controllers/AdminBannerAdsController.js') }}" type="text/javascript"></script>
      <script src="{{ URL::asset('js/controllers/BannerAdsController.js') }}" type="text/javascript"></script>
      ...
      <script src="{{ URL::asset('js/controllers/SuperSubsController.js') }}" type="text/javascript"></script>
      ...
      <script src="{{ URL::asset('js/controllers/CompitionController.js') }}" type="text/javascript"></script>
