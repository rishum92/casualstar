      ...
      <form name="viewPhoto" ng-submit="submitModal('viewPhoto')" files="true" novalidate>
        ...
        <div class="modal-body">
          <div class="explore-photo">
            <a href="users/[[users.username]]?explore=true"><img ng-src="[[getPhotoUrl(us.user_profile)]]" alt="user photo" /></a>
          </div>
          ...
          <div class="messages">
            <div class="form-group right comments">
              ...
              <form data-ng-submit="postComment([[users.user_id]])">
                ...
                <button ng-disabled="comment.length == 0" type="button" id="postCommentButton" ng-click="postComment([[users.user_id]])" ng-disabled="viewPhoto.$invalid" class="post-comment-btn form-btn main-btn stroke-btn"><i class="fa fa-check"></i></input></button>
              </form>
